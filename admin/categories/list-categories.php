<div class="col-md-7">
    ...
    <a href="?act=addcate" class="btn btn-success" style="background-color:#25bc7c">Thêm mới</a>
    <table id="table_sta" class="table">
        <thead>
            <tr>
                <th scope="col">STT</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 150px;">
                    <a href="?act=editcate&id=<?php echo $value['id']; ?>" class="btn btn-warning">Sửa</a>
